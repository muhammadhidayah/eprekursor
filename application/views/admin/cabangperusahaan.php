    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          ...
          ?>
          <h3 class="box-title">Data Cabang Perusahaan</h3>
          ...
          <table id="example2" class="table table-bordered table-striped">
            ...
            <?php $i = 1; foreach ($cabang as $cabang): ?>
              <tr>
                ...
                <td>
                	<a href="<?php echo site_url('admin/perusahaan/editcabang/'. $cabang->id_cabperusahaan); ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Sunting</a>
                	<a href="<?php echo site_url('admin/perusahaan/hapuscabang/'.$cabang->id_cabperusahaan); ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus</a>
                </td>
              </tr>
            <?php endforeach; ?>
            </tbody>
